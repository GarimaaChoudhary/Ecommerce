...
import { LinearProgress,Box,Grid,Rating,Button } from "@mui/material";
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p clasName="font-semibold">{products.product?.discountedPrice}</p>
        ...
        <section className="pt-10">
          ...
          <h1 className="py-5 text-xl font-bold">Similar Proucts</h1>
